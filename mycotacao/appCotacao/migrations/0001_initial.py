# Generated by Django 4.0 on 2024-08-04 02:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fornecedor', models.ManyToManyField(to='appCotacao.Fornecedor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('0', 'start'), ('1', 'fornecedor'), ('2', 'admim'), ('3', 'Finalizado'), ('4', 'Nao Pode mais dar Lance'), ('5', 'Finalizado sem acordo')], max_length=1, null=True)),
