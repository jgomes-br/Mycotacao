# Generated by Django 4.0 on 2024-10-29 02:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('produto', models.ManyToManyField(to='appCotacao.Produto')),
            ],
        ),
        migrations.CreateModel(
            name='Estrutura',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('1', 'Cotando'), ('2', 'Aceitar ou Recusar'), ('3', 'Finalizado'), ('5', 'Finalizado sem acordo')], max_length=1, null=True)),
                ('volume', models.IntegerField(null=True)),
                ('total_lances', models.SmallIntegerField(default=4)),
                ('lances', models.ManyToManyField(to='appCotacao.Lance')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contrato', models.DecimalField(decimal_places=2, default=Decimal('0.0'), max_digits=5)),
