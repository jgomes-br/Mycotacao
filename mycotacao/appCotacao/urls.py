...
urlpatterns = [
    ...
    path('cotacao/<int:projeto_id>', views.CotacaoView.as_view(), name="cotacao"),
    path('cotacaoadm/<int:projeto_id>/<int:fornecedor_id>', views.CotacaoView.as_view(), name="cotacaoadm"),
