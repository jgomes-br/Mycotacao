...
#     def __init__(self, projetodono:CustomUser, fornecedor: CustomUser, valor: str) :
#         self.dono = dono

#         try:
#             self.qtd_lances = len(self.lances.all())
...
# def gravar_resposta(dono, id_estrutura: int, novo_custo):
